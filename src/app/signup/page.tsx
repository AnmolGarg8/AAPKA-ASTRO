...
import { SignUp } from "@/components/auth/ClerkAuthWrapper";
import { MandalaDivider } from "@/components/ui/MandalaDivider";
import { ShieldCheck, CheckCircle2, Lock, Gift, Sparkles } from "lucide-react";
            ...
            localization={{
              unstable__errors: {
                form_identifier_not_allowed:
                  "This email domain cannot be used for registration. Please use a permanent email address (such as Gmail, Yahoo, Outlook, or iCloud) so you can receive your Janam Kundli charts and consultation updates.",
              },
            }}
          />
        </div>
